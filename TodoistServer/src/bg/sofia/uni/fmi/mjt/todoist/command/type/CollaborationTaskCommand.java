...
public class CollaborationTaskCommand {
    ...
    public CollaborationTaskCommand(CollaborationTaskStorage collaborationTaskStorage, String collaborationName) {
        this.collaborationTaskStorage = collaborationTaskStorage;
