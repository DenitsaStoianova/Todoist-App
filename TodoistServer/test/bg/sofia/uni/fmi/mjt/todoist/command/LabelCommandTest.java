...
public class LabelCommandTest {
    ...
    @Test
    public void testAddLabelSuccess() throws IOException {
    ...
    @Test
    public void testAddLabelAlreadyExisting() throws IOException {
    ...
    @Test
    public void testDeleteLabelSuccess() throws IOException {
    ...
    @Test
    public void testDeleteLabelNotExisting() throws IOException {
    ...
    @Test
    public void testListLabelsSuccess() throws IOException {
    ...
    @Test
    public void testListLabelsNoLabels() throws IOException {
    ...
    @Test
    public void testLabelTaskNotExistingInboxTask() throws IOException {
    ...
    @Test
    public void testLabelTaskNotExistingOrdinaryTask() throws IOException {
        when(taskStorage.getTaskData()).thenReturn(null);
        final String expected = "[ Task \"task\" does not exist in your workspace. ]";
        String actual = labelCommand.execute(CommandType.LABEL_TASK,
                Map.ofEntries(Map.entry(CommandKeywords.NAME, "task"),
    ...
    @Test
    public void testLabelInboxTaskSuccess() throws IOException {
    ...
    @Test
    public void testLabelInboxTaskFailure() throws IOException {
        when(taskStorage.getTaskData()).thenReturn(new InboxTask("task"));
    ...
    @Test
    public void testListTasksSuccess() throws IOException {
    ...
    @Test
    public void testListTasksNoTasks() throws IOException {
        when(labelStorage.listTasks("project")).thenReturn(null);
